...
<!-- Navigation -->
	...
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="http://walnutcapital.com/bakery-bootcamp/">Boot Camp Bakery</a>
		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						...
						<h1><strong>Delete From Bakery Database</h1>
						...
						<h1 style="color:#ffcc99"><strong>Delete</strong></h1>
