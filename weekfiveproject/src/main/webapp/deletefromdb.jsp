			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						...
						<h1 style="background-color:white">Delete From Bakery Database</h1>
					...
					<br>
						...
						<h1 style="background-color:white">Delete</h1>
							 <form action= "deleteFromDB" style="background-color:white" method="post">
